        ...
        <>
            ...
            >
                ...
                <Box sx={{ maxWidth: 250 }}>
                    ...
                    <Typography>Hey there! Thanks for visiting us.</Typography>
                    <Box sx={{ mt: 2 }}>
                ...
                {/* Guides */}
                <Box sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
                    <Typography variant="h6">View Guides</Typography>
                ...
                {/* Contact */}
                <Box sx={{ display: "flex", flexDirection: "column", alignItems: "flex-start", maxWidth: 250 }}>
                    <Typography variant="h6">Contacts</Typography>
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1, whiteSpace: "nowrap" }}>
                        <LocationOn fontSize="small" />
                        <Typography>Bangalore, India 782132</Typography>
                    </Box>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                        ...
                        <Typography>candles@shop.com</Typography>
                    </Box>
                </Box>
            </Box>
            ...
            <Box sx={{ textAlign: "center", py: 2, bgcolor: "#3a0d6a", color: "white" }}>
                <Typography variant="body2">© 2025 Exotic Candles. All rights reserved.</Typography>
            </Box>
        </>
    );
};
